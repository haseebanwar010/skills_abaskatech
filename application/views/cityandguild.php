...
<div class="container aboutuscontent">
    <div class="row">
        <div class="whatwedo col-lg-12 col-sm-12">
            <h1><?php echo $cityandguild['title']; ?></h1>
            <img src="<?php echo $baseUrl;?>uploads/<?php echo $cityandguild['image']; ?> "/>
            <div class="content"><p><?php echo $cityandguild['description']; ?></p></div>
        </div>
    </div>
</div>
