        ...
        <ul class="nav navbar-nav">
          <!-- Messages: style can be found in dropdown.less-->
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets/images/admin_login.png'); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php if($this->session->userdata());$rec=$this->session->userdata(); echo $rec['name']; ?></span>
            </a>
<!--            admin/dist/img/user2-160x160.jpg-->
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url('assets/images/admin_login.png'); ?>" class="img-circle" alt="User Image">

                <p>
                  <?php if($this->session->userdata());$rec=$this->session->userdata(); echo $rec['name']; ?> - Web Administrator
                  <small></small>
                </p>
              </li>
              <!-- Menu Body -->
