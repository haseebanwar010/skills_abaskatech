...
class Addresses extends CI_Controller {
	...
	public function index( $msg = NULL)
	{
		...
		$data['addresses'] = $this->config_model->get_addresses();
		...
		if(! $this->session->userdata('validated')){
			redirect('auth');
				...
				$this->load->view('admin/addresses/edit', $data);
...
//        else{
			...
			else
			{
				...
				$this->config_model->update_addresses();
				$this->session->set_flashdata('msg', 'Addresses are updated Successfully!');
